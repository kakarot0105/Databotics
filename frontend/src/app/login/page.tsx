      ...
      <div className="animate-slide-up w-full max-w-md">
        ...
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Sign in to your Databotics workspace</p>
          </div>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          No account?{" "}
          <Link className="font-medium text-indigo-400 transition-colors hover:text-indigo-300" href="/register">
            Create one
          </Link>
        </p>
      </div>
